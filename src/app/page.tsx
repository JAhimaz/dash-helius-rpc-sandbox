...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    localStorage.setItem("dash-theme", darkMode ? "dark" : "light");
  }, [darkMode]);
      ...
      <div className="mx-auto max-w-6xl space-y-3">
        <header>
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <a
                href="https://github.com/JAhimaz/dash-helius-rpc-sandbox"
                target="_blank"
              ...
              <button
                ...
                className="text-foreground/50 transition-colors hover:text-foreground cursor-pointer"
          ...
          >
            <div className="overflow-hidden">
              ...
              >
                ...
                <div className="h-[260px] overflow-y-auto rounded-lg bg-[var(--surface-strong)] p-3 font-mono text-xs">
                    ...
                    consoleLogs.map((entry, index) => (
                      <details key={`${entry.timestamp}-${index}`} className="mb-1 group">
                        ...
                        <div className="relative mt-1 mb-2 ml-[18px]">
                          <button
                            type="button"
                            className="absolute right-2 top-2 rounded-md border border-border/50 bg-[var(--surface-strong)] p-1 text-foreground/40 hover:text-foreground/80 transition-colors"
                          ...
                          <pre className="overflow-x-auto whitespace-pre-wrap break-words rounded-md border border-border/50 bg-[var(--surface)] p-2.5 pr-8 text-foreground/80">
                            {stringifyConsoleOutput(entry.output)}
                          </pre>
                        </div>
                      </details>
        ...
        <section className="space-y-3">
          {orderedNodes.length === 0 ? (
            <div className="flex h-[680px] flex-col items-center justify-center gap-4 rounded-xl border border-dashed border-border bg-[var(--canvas-bg)] text-center">
